...
import { GenerationType, GenerationConfig, AspectRatio, ImageSize } from '../types';
import CanvasEditor from './CanvasEditor';

/* 
 * Corrigindo erros de tipos importando as interfaces e enums atualizados em types.ts.
 * GenerationConfig e outros tipos de mídia agora estão disponíveis.
 */
